...
//      the Go interpreter.
//
// The Go tree-walking interpreter handles ALL Lunex execution.
// Fast-Go loop optimizations are applied transparently at runtime.
// The NTZ section is no longer written to new .nc containers.
//
...
func EncodeExported(e *ExportedChunk) ([]byte, error) {
	...
	// Always pass nil for the NTZ section — the Go interpreter handles all execution.
